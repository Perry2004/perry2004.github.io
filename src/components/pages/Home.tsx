    ...
    <div className="gradient-bg-responsive relative flex min-h-screen flex-col justify-evenly overflow-hidden">
      ...
      <div className="relative z-10 mx-4 w-auto max-w-full sm:mx-8 sm:w-4/5 md:ml-12 md:w-3/4 lg:ml-24 lg:w-2/3 xl:ml-48 xl:w-1/2">
        <div className="relative">
          <h1 className="gradient-text mt-3 from-[#2f4eff] to-[#ff1281] p-1 font-great-vibes text-4xl font-bold !leading-normal dark:from-[#64d1ff] dark:to-[#fab7ff] sm:mt-0 sm:text-5xl md:text-6xl">
            Hello World!
          </h1>
          <div className="gradient-divider-responsive mb-3 w-32 sm:w-36 md:w-40"></div>
        </div>

        <p className="rounded-lg border border-[#5ad6ff]/30 bg-white/40 p-3 text-base leading-relaxed text-gray-700 shadow-sm backdrop-blur-sm dark:border-[#5ad6ff]/50 dark:bg-gray-800/40 dark:text-gray-200 dark:shadow-md sm:text-lg md:text-xl">
