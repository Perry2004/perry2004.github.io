...
export function CarouselNavigationButton({
  ...
  return (
    <Button
      className={`z-5 flex h-9 w-9 appearance-none items-center justify-center rounded-full border-0 bg-white/80 p-0 text-neutral-800 shadow-md transition-all duration-200 ease-in-out hover:bg-white hover:shadow-lg ${
